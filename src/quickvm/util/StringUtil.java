...
/**
 * Credits to @tchrist: https://stackoverflow.com/questions/3537706/how-to-unescape-a-java-string-literal-in-java
 */
...
void say(String what) {
    ...
    public static String stripComment(String str) {
        ...
        while (i < str.length()) {
            if (insideString) {
                if (str.charAt(i) == '\\') i++;
                else if (str.charAt(i) == '"') insideString = false;
            } else {
                if (str.charAt(i) == '#') break;
                else if (str.charAt(i) == '"') insideString = true;
            }
            i++;
        }
